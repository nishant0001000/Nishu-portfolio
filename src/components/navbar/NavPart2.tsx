            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-3 items-center p-2 rounded-lg transition-all duration-200 hover:bg-black/10 dark:hover:bg-white/10 group">
                <div className="flex justify-center items-center">
                  <Image src="/images/speak-dark.gif" alt="mic" width={35} height={35} className="dark:hidden" />
                  <Image src="/images/speak-light.gif" alt="mic" width={35} height={35} className="hidden dark:block" />
                </div>
                <span className="transition-colors text-black/80 dark:text-white/80 group-hover:text-black dark:group-hover:text-white">Speech</span>
              </div>
            </div>
