  ...
  return (
    <div className="flex gap-2 items-center sm:gap-4">
      ...
      <div className="hidden gap-2 items-center sm:flex sm:gap-4">
            ...
            {isSearchExpanded ? (
              ...
              <div className="relative group">
                ...
                <button
                  ...
                  className="flex overflow-hidden relative justify-center items-center w-9 h-9 rounded-full border transition-all duration-300 cursor-pointer bg-black/10 dark:bg-white/10 hover:bg-black/20 dark:hover:bg-white/20 border-black/20 dark:border-white/20"
                >
        ...
        <div className="relative group">
          <div className="absolute inset-0 bg-gradient-to-r rounded-full blur-lg transition-all duration-500 from-blue-500/20 via-purple-500/20 to-pink-500/20 group-hover:blur-xl"></div>
          <button className="flex overflow-hidden relative justify-center items-center w-9 h-9 rounded-full border transition-all duration-300 bg-black/10 dark:bg-white/10 hover:bg-black/20 dark:hover:bg-white/20 border-black/20 dark:border-white/20">
            <div className="absolute inset-0 bg-gradient-to-r from-transparent to-transparent transition-transform duration-1000 -translate-x-full via-black/10 dark:via-white/10 group-hover:translate-x-full"></div>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="relative z-10 transition-all duration-300">
        ...
        <div className="relative group">
          <div className="absolute inset-0 bg-gradient-to-r rounded-full blur-lg transition-all duration-500 from-blue-500/20 via-purple-500/20 to-pink-500/20 group-hover:blur-xl"></div>
          <a href="https://github.com/nishant0001000" target="_blank" rel="noopener noreferrer" className="flex overflow-hidden relative justify-center items-center w-9 h-9 rounded-full border transition-all duration-300 bg-black/10 dark:bg-white/10 hover:bg-black/20 dark:hover:bg-white/20 border-black/20 dark:border-white/20">
            <div className="absolute inset-0 bg-gradient-to-r from-transparent to-transparent transition-transform duration-1000 -translate-x-full via-black/10 dark:via-white/10 group-hover:translate-x-full"></div>
            <svg viewBox="0 0 438.549 438.549" className="relative z-10 transition-all duration-300 size-4">
        ...
        <div className="relative group">
          <div className="absolute inset-0 bg-gradient-to-r rounded-full blur-lg transition-all duration-500 from-blue-500/20 via-purple-500/20 to-pink-500/20 group-hover:blur-xl"></div>
          <a href="https://instagram.com/nishant_mogahaa" target="_blank" rel="noopener noreferrer" className="flex overflow-hidden relative justify-center items-center w-9 h-9 rounded-full border transition-all duration-300 bg-black/10 dark:bg-white/10 hover:bg-black/20 dark:hover:bg-white/20 border-black/20 dark:border-white/20">
            <div className="absolute inset-0 bg-gradient-to-r from-transparent to-transparent transition-transform duration-1000 -translate-x-full via-black/10 dark:via-white/10 group-hover:translate-x-full"></div>
            <svg className="relative z-10 transition-all duration-300 size-4" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="relative group">
          <div className="absolute inset-0 bg-gradient-to-r rounded-full blur-lg transition-all duration-500 from-blue-500/20 via-purple-500/20 to-pink-500/20 group-hover:blur-xl"></div>
          <a href="https://twitter.com/nishant_mogahaa" target="_blank" rel="noopener noreferrer" className="flex overflow-hidden relative justify-center items-center w-9 h-9 rounded-full border transition-all duration-300 bg-black/10 dark:bg-white/10 hover:bg-black/20 dark:hover:bg-white/20 border-black/20 dark:border-white/20">
            <div className="absolute inset-0 bg-gradient-to-r from-transparent to-transparent transition-transform duration-1000 -translate-x-full via-black/10 dark:via-white/10 group-hover:translate-x-full"></div>
            <svg className="relative z-10 transition-all duration-300 fill-current size-3" height="23" viewBox="0 0 1200 1227" width="23" xmlns="http://www.w3.org/2000/svg">
